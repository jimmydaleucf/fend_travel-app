...
function processInfo(e) {
  ...
  Client.getCityCoords(baseURL, destination, geonames_user_key) //get the coords of the destination to be used in the Weather API//
    .then(function (data) {
      ...
      if (dateDiff > 7) {
        // if further out than a week, call and get the future weather conditions
          ...
          .then(function (json) {
            Client.postData("http://localhost:8081/addData", {
              ...
              Client.getPhoto().then(function (image_url) {
                //this function fetches the appropriate image from Pixabay
              });
            });
        ...
        //if trip is within 7 days, call the current forecast API
        ...
        //if date occurs in the past-- alert user to input a valid departure date
